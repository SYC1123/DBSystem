...
public class QueryPlaceNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private QueryPlaceCallback callback;
    ...
    public void startNetThread(final String host, final int port, final String data, QueryPlaceCallback myCallback) {
