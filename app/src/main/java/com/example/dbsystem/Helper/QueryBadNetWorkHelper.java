...
public class QueryBadNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private QueryBadCallback callback;
    ...
    public void startNetThread(final String host, final int port, final String data, QueryBadCallback myCallback) {
