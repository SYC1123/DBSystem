...
public class RepairNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private RepairCallback callback;
    ...
    public Handler handler = new Handler() {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            callback.onRepairSucceed((String) msg.obj);
        }
    };

    public void startNetThread(final String host, final int port, final String data, RepairCallback myCallback) {
