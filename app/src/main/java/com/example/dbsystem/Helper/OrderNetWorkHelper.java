...
public class OrderNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private OrderCalllback callback;
    ...
    public void startNetThread(final String host, final int port, final String data, OrderCalllback mycallback) {
