...
public class CollectNetWorkHelper {
...
//            Log.d("123456", "handleMessage: "+msg.obj);
            callback.onCollectSucceed((String) msg.obj);
        }
    };
    public void startNetThread(final String host, final int port, final String data, CollectCallback myCallback) {
