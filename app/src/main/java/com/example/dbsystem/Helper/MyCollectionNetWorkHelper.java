...
public class MyCollectionNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private MyCollectionCallback callback;
    ...
    public void startNetThread(final String host, final int port, final String data, MyCollectionCallback mycallback) {
