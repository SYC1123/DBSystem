...
public class ReservationNetWorkHelper {
    ...
    public ReservationNetWorkHelper(AppCompatActivity appCompatActivity) {
    ...
    public Handler handler = new Handler() {
        ...
        public void handleMessage(@NonNull Message msg) {
            callback.onResSucceed((String) msg.obj);
        }
    };

    public void startNetThread(final String host, final int port, final String data, ReservationCallback myCallback) {
